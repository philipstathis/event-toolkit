...
## Eventbrite Specific Implementation (Events.js)

- Setup your eventbrite developer token
- set up a secret for use in the serverless app [https://serverless-stack.com/chapters/storing-secrets-in-serverless-apps.html]
- call it `/eventbrite/live`, or change events.js

## Custom Serverless Setup
- `yarn install`
